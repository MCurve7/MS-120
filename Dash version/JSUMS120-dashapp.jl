    ...
    app.layout = html_div([
        ...
        html_div([
            dcc_markdown("""\$f(x) =\$""", 
                ...
                # html_div(dcc_input(id = "function", value = "x/(x^2+2)", type = "text"),
                # html_div(dcc_input(id = "function", value = "33/(x+7)^(2/5)", type = "text"),
                # html_div(dcc_input(id = "function", value = "(2*x^2-3*x)/(x^2+9)", type = "text"),
