...
# ╔═╡ e0c50320-ca7b-11ee-377d-03305ef318f9
begin
	using PrettyTables
...
# ╔═╡ aabe34db-fdf6-4da2-9d34-f8e4add25512
html"""
	<style>
		@media screen {
			main {
...
# ╔═╡ e5b17974-732d-40b1-a9f0-a580d14f5315
begin
...
# ╔═╡ 911b177a-fb07-462a-9589-b6247c0c8402
md"""
Make sure that the file JSUMS120.jl is in the same directory as this file is saved in.

You can delete this text and start your code here.
If you can't see this text as a code block (you should see `md` followed by three double quote marks) 
then hover your mouse cursor over this block of text and you will see a crossed out eyeball icon.
Click that icon and you will see this codeblock.
"""
...
manifest_format = "2.0"
project_hash = "421176afaf9d215af65a6738d494a6359d358db7"
...
git-tree-sha1 = "0c867b02adb47bd4864af2c4f827f3d03c5a61ce"
